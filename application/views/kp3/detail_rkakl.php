                                    ...
                                    <?php $total=0;$total_p=0;$total_r=0;$total_s=0; foreach ($ro as $a) { ?>
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo "Rp. ".number_format($saldo,0,'','.' ).",-"; ?></td>
                                          <td>
                                            <a href="#edit_rkakl<?php echo $a->id;?>" class="btn-floating gradient-45deg-light-blue-cyan tooltipped modal-trigger" data-position="top" data-tooltip="Edit RO"><i class="material-icons dp48">edit</i></a>
                                            <a href="<?php echo base_url(); ?>pejabat_teknis/hapus_detail_rkakl/<?php echo $result->id_rkakl; ?>/<?php echo $a->id_detail_rkakl; ?>" class="btn-floating red tooltipped modal-trigger" data-position="top" data-tooltip="Hapus RO" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="material-icons dp48">delete</i></a>
                                          </td>
                                      </tr>
