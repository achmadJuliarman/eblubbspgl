...
<table width="100%" border="0">
  ...
  <td style="font-size:16px; text-align:center;margin:0;line-height: 30px;"><br />
    <strong> K U I T A N S I</strong></br>
		<u>No. <?php echo $result->no_kwitansi; ?></u>
  </td>
  </tr>
</table>
<table width="100%">
  <tbody>
    <tr style="font-size:12px;">
      ...
      <td width="70%" style="text-align:left">&nbsp;&nbsp;<?php echo $result->nama_perusahaan;?></td>
    </tr>
    <tr style="font-size:12px;">
...
<table width="100%">
  <tbody>
    <tr style="font-size:12px;">
      <td width="15%" height="30" style="text-align:center" colspan="2">&nbsp;&nbsp;<b><?= "Rp.".number_format($result->jumlah_realisasi).",-" ?></b></td>
      <td></td>
    </tr>
  </tbody>
</table>
