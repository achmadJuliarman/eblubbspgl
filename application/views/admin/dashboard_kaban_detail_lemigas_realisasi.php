                ...
                <div class="card-content">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h6 class="card-subtitle">Data Realisasi</h6>
                        </div>
                    </div>
                    <div class="table-responsive m-b-20">
                      ...
                      <table id="demo-foo-addrow2" class="table table-bordered table-hover toggle-circle" data-page-size="20">
                            ...
                            <tbody>
                              <?php $no=1; foreach ($realisasi_lemigas as $a) { ?>
                                <tr>
                                    <td>
                                        <?php echo $no; ?>
                                    </td>
                                    <td class="blue-grey-text text-darken-4 font-medium"><b><?php echo $a->kontrak_nama; ?></b><br><?php echo $a->perusahaan_nama; ?></td>
                                    ...
                                    <td class="blue-grey-text text-darken-4 font-medium"><?php echo "Rp. ".number_format($a->termin_nilai_rp,0,'','.' ).",-"; ?></td>
                                </tr>
                              <?php
                              $no=$no+1; }
                              ?>
