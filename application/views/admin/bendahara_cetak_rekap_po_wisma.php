...
foreach ($result as $a)
{
	$total=$total+$a->jumlah_realisasi;
}
?>
...
<table width="100%" rules="all" border="1">
  ...
  <tbody>
		<?php $no=1; $total = 0; foreach ($result as $a) { ?>
	      ...
	      <td style="padding-left:10px;padding-right:5px;"><?php echo $a->nama_perusahaan;?></td>
	      <td style="text-align:center;"><?php echo $a->tgl_checkin;?></td>
	      <td style="text-align:center;"><?php echo $a->tgl_checkout;?></td>
	      <td style="text-align:center;"><?php echo $a->nama_layanan;?></td>
	      <td style="text-align:center;"><?php echo $a->jumlah_kamar;?></td>
	      <td style="padding-left:10px;padding-right:5px;"><?php echo $a->no_invoice;?></td>
	      <td style="padding-left:10px;padding-right:5px;"><?php echo $a->no_kwitansi;?></td>
	      <td style="text-align:center"><?= "Rp.".number_format($a->jumlah_realisasi).",-" ?></td>
	    </tr>
		<?php $no=$no+1; $total=$total+$a->jumlah_realisasi; } ?>
    <tr style="font-size:12px;">
      <td height="30" style="text-align:center" colspan="8"><b>JUMLAH&nbsp;&nbsp;&nbsp;</b></td>
