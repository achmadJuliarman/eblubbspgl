                            ...
                            <div class="card">
                                <div class="card-content">
                                  <div class="d-flex align-items-center">
                                      <div>
                                        <h4 class="card-title">Daftar Target Tahun <?php echo $pilih_tahun; ?></h4>
                                        <h6 class="card-subtitle">You have <?php echo $jumlah; ?> Target</h6>
                                      </div>
                                      <div class="ml-auto">
                                        <?php echo form_open_multipart('admin/target');?>
                                    ...
                                    <table id="demo-foo-addrow2" class="table table-bordered table-hover toggle-circle" data-page-size="10">
                                      <thead>
                                          <tr>
                                            ...
                                            <th width="30%"><center>Pelaksana Layanan</center></th>
                                            <th width="45%"><center>Target</center></th>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <center>
                                                ...
                                                <a href="<?php echo base_url();?>admin/hapus_target/<?php echo $a->id_target;?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus Target" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash"></i></a>
                                              </center>
                                            </td>
                                          </tr>
                                        <?php $no=$no+1; } ?>
                ...
                <div id="modaltambah" class="modal">
                  <?php echo form_open_multipart('admin/input_target');?>
                    <div class="modal-content">
                        <h4>Data Target</h4>
                            <div class="row">
                                <div class="input-field col s12">
                                  <select name="id_rumah_layanan" required>
                                      <option value="" selected>Pilih Pelaksana Layanan</option>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                  <input id="nama" type="number" name="jumlah" maxlength="100" min="1" required>
                ...
                <div id="modaledit<?php echo $a->id_target?>" class="modal">
                  <?php echo form_open_multipart('admin/edit_target');?>
                    <div class="modal-content">
                        <h4>Data Target</h4>
                            <div class="row">
                                <div class="input-field col s12">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                  <input id="nama" type="number" name="jumlah" maxlength="100" min="1" value="<?php echo $a->jumlah; ?>" required>
                                  <label for="nama">Target</label>
                                </div>
                            </div>
                            <div class="row">
