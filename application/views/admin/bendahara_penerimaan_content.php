              ...
              foreach ($result as $a) { ?>
                <tr>
                  ...
                  <td>
                    ...
                    <?php $tanggal = strtotime($a->tgl_invoice);
                    $tanggal_hari_ini = strtotime("now");
                    $hari = ($tanggal_hari_ini - $tanggal) / (60 * 60 * 24); ?>
                    <?php if ($a->status_pembayaran == 0) { ?>
                      <!-- <?php if ($a->jumlah_penagihan > 0) { ?>
                                  <?php $tagihan = $this->db->query("SELECT * FROM penagihan WHERE id_termin = $a->id_termin AND keterangan = $a->jumlah_penagihan")->row();
                                  echo $penagihan->tgl_termin;
                                  echo $a->id_termin; ?>
                                <?php } ?> -->
                      <?php if ($hari >= 30) { ?>
                        <br />
                        <?php if ($a->jumlah_penagihan > 0) { ?>
                          ...
                          <?php $tanggal_telat = strtotime($status_penagihan->tgl_termin);
                          $tanggal_hari_ini = strtotime("now");
                          $hari_penagihan = ($tanggal_hari_ini - $tanggal_telat) / (60 * 60 * 24); ?>
