                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <center>
                                                ...
                                                <?php $cek = $this->db->query("SELECT * FROM kontrak WHERE id_rumah_layanan = $a->id_rumah_layanan;")->num_rows(); ?>
                                                <?php if($cek == 0) { ?>
                                                  <a href="<?php echo base_url();?>admin/hapus_rumah_layanan/<?php echo $a->id_rumah_layanan;?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus Pelaksana Layanan" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash"></i></a>
                                                <?php } ?>
                                              </center>
                                            </td>
                                          </tr>
                ...
                <div id="modaltambah" class="modal">
                  <?php echo form_open_multipart('admin/input_rumah_layanan');?>
                ...
                <div id="modaledit<?php echo $a->id_rumah_layanan?>" class="modal">
                  <?php echo form_open_multipart('admin/edit_rumah_layanan');?>
                    <div class="modal-content">
                        <h4>Data Pelaksana Layanan</h4>
                            <div class="row">
                                <div class="input-field col s12">
