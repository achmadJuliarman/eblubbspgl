			      ...
			      <span class="label label-table label-info"><?php echo $a->no_urut; ?></span>
                            ...
                            <td>
                              ...
                              <?php if ($a->status_pengajuan == 0 ) { ?>
                                <!-- <a href="<?php echo base_url();?>tata_usaha/detail_rkakl/<?php echo $a->id_rkakl;?>" class="btn btn-small cyan btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Detail RKAKL"><i class="fas fa-cog"></i></a> -->
                                ...
                                <a href="<?php echo base_url();?>tata_usaha/hapus_pengajuan_rkakl/<?php echo $a->id_pengajuan;?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus Pengajuan" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash"></i></a>
                              <?php } else { ?>
