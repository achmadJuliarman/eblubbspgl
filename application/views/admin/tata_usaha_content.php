                          ...
                          <tr>
                            ...
                            <td>
                              <center>
                                ...
                                <a href="#modaledit" class="btn btn-small green btn-outline tooltipped modal-trigger" data-position="top" data-delay="50" data-tooltip="Edit RKAKL"><i class="far fa-file-alt"></i></a>
                                <a href="<?php echo base_url();?>tata_usaha/hapus_rkakl/<?php echo $a->id_rkakl;?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus RKAKL" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash"></i></a>
                              </center>
                            </td>
                          </tr>
                        <?php $no=$no+1; } ?>
