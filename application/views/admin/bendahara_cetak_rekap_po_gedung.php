...
<table width="100%" rules="all" border="1">
  ...
  <tbody>
		<?php $no=1; $total = 0; foreach ($result as $a) { ?>
	      ...
	      <td style="text-align:center;"><?php echo $a->tgl_acara;?></td>
	      <td style="text-align:center;"><?php if($a->waktu_acara == 1) { echo "Siang"; } else { echo "Malam"; }?></td>
    ...
    <tr style="font-size:12px;">
      <td height="30" style="text-align:center" colspan="6"><b>JUMLAH&nbsp;&nbsp;&nbsp;</b></td>
