            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        <h4 class="card-title">Detail PO Sewa Gedung</h4>
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                  <td>
                                    <b>Kategori</b><br/>
                                    <?php if ($result->kategori_kesdm == 1) { echo "KESDM"; } else { echo "Non KESDM"; }?>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                ...
                                <tr>
                                  <td>
                                    ...
                                    <?php echo $this->format_tanggal->jin_date_str($result->tgl_acara); ?>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                    <b>Waktu Acara</b><br/>
                                    <?php if ($result->waktu_acara == 1) { echo "Siang"; } else { echo "Malam"; }?>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
