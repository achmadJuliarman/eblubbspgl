...
<div id="modalpengajuanedit<?php echo $a->id_pengajuan;?>" class="modal">
  <?php echo form_open_multipart('ppk/edit_pengajuan');?>
                                        ...
                                        <?php $no=1; foreach($result AS $a) { ?>
                                          <tr>
                                            ...
                                            <td style="text-align:center;">
                                              <a href="<?php echo base_url();?>ppk/detail_kontrak/<?php echo $a->id_kontrak;?>" class="btn-floating blue tooltipped" data-position="top" data-tooltip="Preview"><i class="material-icons right">remove_red_eye</i></a>
                                            ...
                                            <?php if ($a->status_pengajuan == 0 ) { ?>
                                              <a href="<?php echo base_url();?>ppk/approve/<?php echo $a->id_pengajuan;?>/1" class="btn-floating green tooltipped" data-position="top" data-tooltip="Approve" onclick="javascript: return confirm('Yakin akan memverifikasi data ?')"><i class="material-icons right">check</i></a>
                                              <a href="#modaltolak<?php echo $a->id_pengajuan;?>" class="btn-floating red tooltipped modal-trigger" data-position="top" data-tooltip="Tolak"><i class="material-icons right">close</i></a>
                                            <?php } ?>
                                            </td>
                                          </tr>
                                        <?php $no=$no+1; } ?>
