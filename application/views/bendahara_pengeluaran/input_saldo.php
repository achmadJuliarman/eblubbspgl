    ...
    <div class="col s12">
      <div class="container">
        <div class="section section-data-tables">
          ...
          <div class="card">
            <div class="card-content">
              <?php echo form_open_multipart('bendahara_pengeluaran/input_saldo'); ?>
              <div class="row">
                                  ...
                                  foreach ($operasional as $ops) { ?>
                                    <tr>
                                      ...
                                      <td style="text-align:center;"><a href="#modaleditops<?php echo $ops->id_operasional; ?>" class="btn btn-small blue btn-outline tooltipped modal-trigger" data-position="top" data-delay="50" data-tooltip="Update Saldo"><i class="far fa-file-alt">Edit</i></a>
                                        <a href="<?php echo base_url(); ?>bendahara_pengeluaran/delete_operasional/<?php echo $ops->id_operasional; ?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus Deposito" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash">Hapus</i></a>
                                      </td>
                                  ...
                                  foreach ($deposito as $a) { ?>
                                    <tr>
                                      ...
                                      <td style="text-align:center;"><a href="#modaledit<?php echo $a->id_deposito; ?>" class="btn btn-small blue btn-outline tooltipped modal-trigger" data-position="top" data-delay="50" data-tooltip="Update Saldo"><i class="far fa-file-alt">Edit</i></a>
                                        <a href="<?php echo base_url(); ?>bendahara_pengeluaran/delete_deposito/<?php echo $a->id_deposito; ?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus Deposito" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash">Hapus</i></a>
                                      </td>
...
<div id="modaloperasional" class="modal">
  <?php echo form_open_multipart('bendahara_pengeluaran/input_operasional'); ?>
...
<?php foreach ($operasional as $ops) { ?>
  <div id="modaleditops<?php echo $ops->id_operasional; ?>" class="modal">
    <?php echo form_open_multipart('bendahara_pengeluaran/edit_operasional'); ?>
    <div class="modal-content">
...
<div id="modaldeposito" class="modal">
  <?php echo form_open_multipart('bendahara_pengeluaran/input_deposito'); ?>
  <div class="modal-content">
...
<?php foreach ($deposito as $a) { ?>
  <div id="modaledit<?php echo $a->id_deposito; ?>" class="modal">
    <?php echo form_open_multipart('bendahara_pengeluaran/edit_deposito'); ?>
    <div class="modal-content">
