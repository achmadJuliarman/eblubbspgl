                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <center>
                                                ...
                                                <a href="<?php echo base_url();?>admin/hapus_detail_layanan/<?php echo $a->id_layanan;?>/<?php echo $a->id_detail;?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus Detail Layanan" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash"></i></a>
                                              </center>
                                            </td>
                                          </tr>
                                        <?php $no=$no+1; } ?>
                ...
                <div id="modaltambah" class="modal">
                  <?php echo form_open_multipart('admin/input_detail_layanan');?>
                ...
                <div id="modaledit<?php echo $a->id_detail?>" class="modal">
                  <?php echo form_open_multipart('admin/edit_detail_layanan');?>
                    <div class="modal-content">
                        <h4>Data Detail Layanan</h4>
                            <div class="row">
                                <div class="input-field col s12">
