                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <center>
                                                ...
                                                <a href="<?php echo base_url();?>admin/hapus_kode_akun/<?php echo $a->id_akun;?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus Kode Akun" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash"></i></a>
                                              </center>
                                            </td>
                                          </tr>
                                        <?php $no=$no+1; } ?>
                ...
                <div id="modaltambah" class="modal">
                  <?php echo form_open_multipart('admin/input_kode_akun');?>
                ...
                <div id="modaledit<?php echo $a->id_akun?>" class="modal">
                  <?php echo form_open_multipart('admin/edit_kode_akun');?>
                    <div class="modal-content">
                        <h4>Data Kode Akun</h4>
                            <div class="row">
                                <div class="input-field col s12">
