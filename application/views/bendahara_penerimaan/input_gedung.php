                    ...
                    <div class="row">
                      <div class="col s12">
                          <div class="card-panel gradient-45deg-light-blue-cyan" style="color: rgba(255, 255, 255, 0.901961);">
                            <span style="color: rgba(255, 255, 255, 0.901961);font-size:20px;"><center>FORM Tambah Data PO Gedung</center></span>
                          </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card-content">
                      ...
                      <div class="row">
                          ...
                          <div class="row">
                              ...
                              <div class="input-field col s12 m6 l6">
                                  <input id="tgl_acara" type="date" name = "tgl_acara" required>
