                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <center>
                                                ...
                                                <a href="<?php echo base_url();?>program/hapus_kode_penerimaan/<?php echo $a->id_akun;?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus Kode Penerimaan" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash"></i></a>
                                              </center>
                                            </td>
                                          </tr>
                                        <?php $no=$no+1; } ?>
                ...
                <div id="modaltambah" class="modal">
                  <?php echo form_open_multipart('program/input_kode_penerimaan');?>
                ...
                <div id="modaledit<?php echo $a->id_akun?>" class="modal">
                  <?php echo form_open_multipart('program/edit_kode_penerimaan');?>
                    <div class="modal-content">
                        <h4>Data Kode Penerimaan</h4>
                            <div class="row">
                                <div class="input-field col s12">
