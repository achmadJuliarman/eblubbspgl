...
<table width="100%">
  <tbody>
    ...
    <tr style="font-size:12px;">
      ...
      <td width="2%"  style="padding-left:10px;padding-right:5px;text-align:center">:</td>
      <td width="70%" style="text-align:left">&nbsp;&nbsp;<?php echo $result->termin_keterangan;?></td>
    </tr>
  </tbody>
</table>
<br/>
<table width="100%">
  <tbody>
    <tr style="font-size:12px;">
      <td width="15%" height="30" style="text-align:center" colspan="2">&nbsp;&nbsp;<b><?= "Rp.".number_format($result->jumlah).",-" ?></b></td>
      <td></td>
    </tr>
  </tbody>
</table>
