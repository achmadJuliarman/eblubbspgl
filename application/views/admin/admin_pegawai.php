                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <center>
                                                ...
                                                <a href="<?php echo base_url();?>admin/hapus_pegawai/<?php echo $a->id;?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus Pegawai" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash"></i></a>
                                              </center>
                                            </td>
                                          </tr>
                                        <?php $no=$no+1; } ?>
                ...
                <div id="modaltambah" class="modal">
                  <?php echo form_open_multipart('admin/input_pegawai');?>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                  <select name="status_kepeg" required>
                                      ...
                                      <option value="tenaga_professional">Tenaga Professional</option>
                                  </select>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="modal-content">
                        <h4>Data Pegawai</h4>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                  <select name="status_kepeg" required>
                                      <option value="<?php echo $a->status_kepeg; ?>" selected><?php
                                        if ($a->status_kepeg === 'PNS') {?>
PNS
                                        <?php }
                                        elseif ($a->status_kepeg === 'non_pns') {?>
Non PNS
                                        <?php }
                                        elseif ($a->status_kepeg === 'pppk') {?>
PPPK
                                        <?php }
                                        elseif ($a->status_kepeg === 'tenaga_professional') {?>
Tenaga Professional
                                        <?php } ?>
                                       </option>
                                      <option value="PNS">PNS</option>
