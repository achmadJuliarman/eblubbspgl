...
<table width="100%" rules="all" border="1">
  ...
  <tbody>
		<?php $no=1; $total = 0; foreach ($result as $a) { ?>
	      ...
	      <td style="padding-left:10px;padding-right:5px;"><?php echo $a->no_lab;?></td>
	      <td style="text-align:center;"><?php echo $a->kode_layanan;?></td>
	      <td style="text-align:center;"><?php echo $a->jumlah_sample;?></td>
	      <td style="padding-left:10px;padding-right:5px;"><?php echo $a->no_sertifikat;?></td>
    ...
    <tr style="font-size:12px;">
      <td height="30" style="text-align:center" colspan="9"><b>JUMLAH&nbsp;&nbsp;&nbsp;</b></td>
