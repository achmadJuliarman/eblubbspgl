                                      ...
                                      <tbody>
                                        <?php $no=1; foreach($result AS $a) { ?>
                                          <tr>
                                            ...
                                            <td>
                                              <center>
                                                <a href="<?php echo base_url();?>program/detail_jenis_layanan/<?php echo $a->id_jenis_layanan;?>" class="btn btn-small cyan btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Detail Layanan"><i class="fas fa-cog"></i></a>
                                                ...
                                                <a href="<?php echo base_url();?>program/hapus_jenis_layanan/<?php echo $a->id_jenis_layanan;?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus Jenis Layanan" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash"></i></a>
                                              </center>
                                            </td>
                                          </tr>
                                        <?php $no=$no+1; } ?>
                ...
                <div id="modaltambah" class="modal">
                  <?php echo form_open_multipart('program/input_jenis_layanan');?>
                                ...
                                <div class="input-field col s12">
                                  <select name="id_rumah_layanan">
                                      ...
                                      <?php foreach ($rumah_layanan as $a) { ?>
                                        <option value="<?php echo $a->id_rumah_layanan; ?>"><?php echo $a->kode_rumah_layanan." - ".$a->nama; ?></option>
                                      <?php } ?>
                                  </select>
                ...
                <div id="modaledit<?php echo $a->id_jenis_layanan?>" class="modal">
                  <?php echo form_open_multipart('program/edit_jenis_layanan');?>
                    <div class="modal-content">
                        <h4>Data Jenis Layanan</h4>
                            <div class="row">
                                <div class="input-field col s12">
