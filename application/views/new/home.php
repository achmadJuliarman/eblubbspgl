        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                                ...
                                <div class="message-box">
                                    <div class="message-widget message-scroll">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="<?php echo base_url();?>assets/new/images/users/d1.jpg" alt="user" class="circle"> <span class="profile-status online pull-right"></span> </div>
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="<?php echo base_url();?>assets/new/images/users/d2.jpg" alt="user" class="circle"> <span class="profile-status busy pull-right"></span> </div>
                                            <div class="mail-contnet">
                                                <h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
                                        </a>
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="<?php echo base_url();?>assets/new/images/users/4.jpg" alt="user" class="circle"> <span class="profile-status away pull-right"></span> </div>
                                            <div class="mail-contnet">
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="<?php echo base_url();?>assets/new/images/users/d4.jpg" alt="user" class="circle"> <span class="profile-status offline pull-right"></span> </div>
                                            <div class="mail-contnet">
                                                <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:02 AM</span> </div>
                                        </a>
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="<?php echo base_url();?>assets/new/images/users/d5.jpg" alt="user" class="circle"> <span class="profile-status online pull-right"></span> </div>
                                            <div class="mail-contnet">
                    ...
                    <div class="col s12 l8">
                        <div class="card news-slide" style="background:url(<?php echo base_url();?>assets/new/images/carousel/img6.jpg) center center / cover;">
                            <div class="carousel carousel-slider" >
                                ...
                                <a class="carousel-item" href="#one!" style="background:url(<?php echo base_url();?>assets/new/images/carousel/img6.jpg) center center / cover;">
                                    <div class="carousel-caption">
                                    ...
                                    <table class="">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="<?php echo base_url();?>assets/new/images/users/d1.jpg" alt="user" class="circle" width="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="<?php echo base_url();?>assets/new/images/users/d2.jpg" alt="user" class="circle" width="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="<?php echo base_url();?>assets/new/images/users/d3.jpg" alt="user" class="circle" width="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="m-r-10"><img src="<?php echo base_url();?>assets/new/images/users/2.jpg" alt="user" class="circle" width="45" /></div>
                                                        <div class="">
                            ...
                            <div class="card-content">
                                ...
                                <div class="comment-widgets scrollable" style="height:560px;">
                                    ...
                                    <div class="d-flex flex-row comment-row">
                                        <div class="p-2"><img src="<?php echo base_url();?>assets/new/images/users/1.jpg" alt="user" width="50" class="circle"></div>
                                    ...
                                    <!-- Comment Row -->
                                    <div class="d-flex flex-row comment-row">
                                        <div class="p-2"><img src="<?php echo base_url();?>assets/new/images/users/4.jpg" alt="user" width="50" class="circle"></div>
                                    ...
                                    <!-- Comment Row -->
                                    <div class="d-flex flex-row comment-row">
                                        <div class="p-2"><img src="<?php echo base_url();?>assets/new/images/users/5.jpg" alt="user" width="50" class="circle"></div>
                                        <div class="comment-text w-100">
                            ...
                            <div class="card-content">
                                ...
                                <div class="chat-box scrollable" style="height:480px;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="<?php echo base_url();?>assets/new/images/users/1.jpg" alt="user"></div>
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="<?php echo base_url();?>assets/new/images/users/2.jpg" alt="user"></div>
                                            <div class="chat-content">
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="<?php echo base_url();?>assets/new/images/users/3.jpg" alt="user"></div>
                                            <div class="chat-content">
