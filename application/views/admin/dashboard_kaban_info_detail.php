                          ...
                          <?php foreach ($result_termin as $a) { ?>
                            <tr>
                              ...
                              <td>
                                ...
                                <?php if($a->jumlah_penagihan > 0) { ?>
                                  <?php if($a->jumlah_penagihan = 4) { ?>
                                    <span class="label label-table label-warning">Piutang Macet</span> <br>
                                    <span class="label label-table label-info"><?php echo $a->keterangan; ?></span>
                                  <?php } else { ?>
                              ...
                              <td>
                                ...
                                <?php if($a->status_cetak_invoice == 1 && $a->status_realisasi==0) { echo "Rp. ".number_format($a->jumlah,0,'','.' ).",-"; } else { echo "-"; }?>
                              </td>
                              <td>
                                <?php if($a->tgl_pembayaran != '0000-00-00') { ?> <span class="label label-table label-success"> <?php echo $a->tgl_pembayaran; ?> </span> <?php } ?> <br>
                                <?php if($a->status_cetak_invoice == 1 && $a->status_realisasi==1) { echo "Rp. ".number_format($a->jumlah,0,'','.' ).",-"; } else { echo "-"; }?></td>
                              <td>-</td>
                            </tr>
                          <?php } ?>
