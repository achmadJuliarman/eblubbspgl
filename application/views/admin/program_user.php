                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <center>
                                                ...
                                                <a href="<?php echo base_url();?>program/reset_password/<?php echo $a->id_user;?>" class="btn btn-small blue btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Reset Password" onclick="javascript: return confirm('Yakin akan mereset data ?')"><i class="fas fa-exchange-alt"></i></a>
                                                <a href="<?php echo base_url();?>program/hapus_user/<?php echo $a->id_user;?>" class="btn btn-small red btn-outline tooltipped" data-position="top" data-delay="50" data-tooltip="Hapus User" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="fas fa-trash"></i></a>
                                              </center>
                                            </td>
                                          </tr>
                                        <?php $no=$no+1; } ?>
                ...
                <div id="modaltambah" class="modal">
                  <?php echo form_open_multipart('program/input_user','class="col s12"');?>
                ...
                <div id="modaledit<?php echo $a->id_user;?>" class="modal">
                  <?php echo form_open_multipart('program/edit_user');?>
                    <div class="modal-content">
                        <h4>Data User</h4>
                            <div class="row">
                                <div class="input-field col s12">
