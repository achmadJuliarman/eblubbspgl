                              ...
                              <tbody>
                                  ...
                                  <tr>
                                    <td>
                                      ...
                                      <?php echo $this->format_tanggal->jin_date_str($result->tgl_ttd); ?>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>
                                      <b>Tanggal Pelaksanaan</b><br/>
                                      <?php echo $this->format_tanggal->jin_date_str($result->tgl_mulai); ?> s/d <?php echo $this->format_tanggal->jin_date_str($result->tgl_akhir); ?>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>
                                  ...
                                  <tr>
                                    <td>
                                      ...
                                      <?php $kategori = $this->session->userdata('admin_kategori'); if($result->file != NULL) { ?>
                                        ...
                                        <?php } ?>
                                        <?php if($kategori == 1) { ?>
                                          <a href="#modaltambah" class="btn mb-1 gradient-45deg-light-blue-cyan mr-1 modal-trigger">Upload File</a>
                                        <?php } ?>
                                    </td>
                                  </tr>
                                  <tr>
