                ...
                <div class="section section-data-tables">
                  <div class="card">
                      <div class="card-content">
                          ...
                          <div class="row">
                              <div class="col s12">
                                <a href="#modalro" class="btn mb-1 waves-effect waves-light gradient-45deg-light-blue-cyan mr-1 modal-trigger">Tambah Data<i class="material-icons left">add_circle</i></a>
                                      ...
                                      <tbody>
                                        <?php $no=1; foreach($result AS $a) { ?>
                                          <tr>
                                            ...
                                            <td>
                			                        <span class="badge blue">No. Urut : <?php echo $a->no_urut; ?></span>
                                              <br/>
                                            ...
                                            <td>
                                              ...
                                              <?php if ($a->status_pengajuan == 0 ) { ?>
                                                <a href="#modaledit<?php echo $a->id_pengajuan; ?>" class="btn-floating green tooltipped modal-trigger" data-position="top" data-tooltip="Edit RKAKL"><i class="material-icons dp48">edit</i></a>
                                                <a href="<?php echo base_url();?>tata_usaha/hapus_pengajuan_rkakl/<?php echo $a->id_pengajuan;?>" class="btn-floating red tooltipped" data-position="top" data-tooltip="Hapus RKAKL" onclick="javascript: return confirm('Yakin akan menghapus data ?')"><i class="material-icons dp48">delete</i></a>
                                              <?php } else { ?>
...
<div id="modalro" class="modal">
  <?php echo form_open_multipart('tata_usaha/input_pengajuan_rkakl');?>
	...
	<div class="row">
            ...
            <div class="row">
                <div class="input-field col s12">
                    <input id="a6" type="text" name="keterangan" maxlength="500">
...
<?php foreach ($result as $a) { ?>
  <div id="modaledit<?php echo $a->id_pengajuan; ?>" class="modal">
    <?php echo form_open_multipart('tata_usaha/edit_pengajuan_rkakl');?>
      <div class="modal-content">
          <h4>Data RKAKL</h4>
              <div class="row">
                  <div class="input-field col s12">
                      <input id="id_pengajuan" type="text" name="id_pengajuan" value="<?php echo $a->id_pengajuan; ?>" maxlength="20" hidden>
                      <input id="a6" type="text" name="keterangan" value="<?php echo $a->keterangan; ?>" maxlength="20">
                      <label for="a9">Keterangan</label>
                  </div>
              </div>
              <div class="row">
